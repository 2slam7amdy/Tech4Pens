    ...
    XF.activate ? console.error("XF core has been double loaded") : (XF.browser || (XF.browser = {
        ...
        XF.CrossTab = function() {
            ...
            var a, b, c, f, e, g, l = !1,
                ...
                x = function(m) {
                    ...
                    k.setHours(0, 0, 0, 0);
                    b + n > e && (k.getDay(),
                        e = r(k, 1), c = r(k, 0), f = r(k, -1), g = r(k, -6));
                    for (var x = 0; x < h; x++) {
                        var p = m[x];
                        var q = d(p);
                        ...
                        var u = p.xfDynType; - 2 > y ? (y = w - (b + n), 60 > y ? "futureMoment" != u && (q.text(XF.phrase("in_a_moment")), p.xfDynType = "futureMoment") : 120 > y ? "futureMinute" != u && (q.text(XF.phrase("in_a_minute")), p.xfDynType = "futureMinute") : 3600 > y ? (w = Math.floor(y / 60), u !== "futureMinutes" + w && (q.text(XF.phrase("in_x_minutes", {
                                    "{minutes}": w
                                })), p.xfDynType = "futureMinutes" + w)) : w < e ? "latertoday" != u &&
                                (q.text(XF.phrase("later_today_at_x", {
                            ...
                            120 >= y ? "minute" !== u && (q.text(XF.phrase("one_minute_ago")), p.xfDynType = "minute") : 3600 > y ? (w = Math.floor(y / 60), u !== "minutes" + w && (q.text(XF.phrase("x_minutes_ago", {
                                "{minutes}": w
                ...
                b = function(a) {
                    if (XF.config.enableRtnProtect && !a.isDefaultPrevented()) {
                        ...
                        if (c && (!c.match(/^[a-z]:/i) || c.match(/^https?:/i))) {
                            ...
                            if (!(b.closest("[contenteditable=true]").length ||
                                    (c = XF.canonicalizeUrl(c), (new RegExp("^[a-z]+://" + location.host + "(/|$|:)", "i")).test(c) || g && g == a.timeStamp || (b.data("blank-handler-last", a.timeStamp), l = navigator.userAgent, b = -1 !== l.indexOf("MSIE"), g = -1 !== l.indexOf("Safari") && -1 == l.indexOf("Chrome"), l = -1 !== l.indexOf("Gecko/"), a.shiftKey && l || g && (a.shiftKey || a.altKey) || b)))) {
                                if (g) b = d('<iframe style="display: none" />').appendTo(k.body), g = b[0].contentDocument || b[0].contentWindow.document, g.__href = c, c = d("<script />", g), c[0].text = "window.opener=null;window.parent=null;window.top=null;window.frameElement=null;window.open(document.__href).opener = null;",
        ...
        XF.create({
            ...
            __construct: function(a, b) {
                ...
                this.$container.html(this.$multiBar).data("multibar",
                ...
                if (!this.shown) {
                    ...
                    this.$multiBar.addClassTransitioned("is-active", function() {
                        if (a.options.focusShow) {
                            var b =
                                a.$multiBar.find(".js-multiBarClose");
            ...
            if (c.cache && XF.loadMultiBar.cache[a]) e(XF.loadMultiBar.cache[a]);
                ...
                var g = function(b) {
                    if (b.redirect)
                        if (c.onRedirect) c.onRedirect(b,
                            g);
            ...
            __construct: function(a, b) {
                ...
                this.options.backdropClose && (this.$container.on("mousedown",
                    function(a) {
                ...
                this.$container.appendTo("body");
                XF.activate(this.$container);
                XF.Overlay.cache[this.$container.attr("id")] =
                    this;
        ...
        XF.loadOverlay = function(a, b, c) {
            ...
            function c(a) {
                ...
                if (XF.Keyboard.isShortcutAllowed(k.activeElement) && (!e.hasOwnProperty(a.key) || 0 != (0 + a.ctrlKey ? 1 : 0 + a.altKey ? 2 : 0 + a.metaKey ? 4 : 0) || !f(e[a.key])) && e.hasOwnProperty(a.which)) {
                    var b =
                        0 + a.ctrlKey ? 1 : 0 + a.altKey ? 2 : 0 + a.metaKey ? 4 : 0;
            ...
            return {
                initialize: function() {
                    XF.PWA.isSupported() && (XF.config.skipServiceWorkerRegistration ?
                        ...
                        }), a() && (d(h).on("beforeunload", b), d(k).on("click",
                            ".js-skipPwaNavIndicator", c))))
                },
            ...
            function b() {
                XF.PWA.getRegistration().then(function(a) {
                    ...
                    XF.Push.isSubscribed ? (d(k).trigger("push:init-subscribed"),
                        XF.config.userId && f(a) ? XF.Push.updateUserSubscription(a, "update") : (a.unsubscribe(), XF.Push.updateUserSubscription(a, "unsubscribe"))) : d(k).trigger("push:init-unsubscribed")
                })
            }
            ...
            function f(a) {
                ...
                if ("string" === typeof a) return XF.config.pushAppServerKey ===
                    a;
            ...
            return {
                ...
                handleUnsubscribeAction: function(a,
                    b) {
                ...
                handleSubscribeAction: function(a, b, c) {
                    XF.Push.isSubscribed || Notification.requestPermission().then(function(d) {
                        if ("granted" !== d) console.error("Permission was not granted");
                            ...
                            var e =
                                XF.Push.base64ToUint8(XF.config.pushAppServerKey);
                            XF.PWA.getRegistration().then(function(d) {
                                d.pushManager.subscribe({
                                    ...
                                    a || d.showNotification(XF.phrase("push_enable_notification_title"),
                                        c);
                ...
                isSupported: function() {
                    return XF.PWA.isSupported() && XF.config.enablePush && XF.config.pushAppServerKey && "PushManager" in
                        h && "Notification" in h
                },
                base64ToUint8: c,
            ...
            function a(a) {
                d(a).find(".js-expandWatch:not(.is-expanded)").each(function() {
                    ...
                    if (b) {
                        ...
                        l();
                        if (!a.data("expand-check-triggered") && (a.data("expand-check-triggered", !0), a.find("img").one("load",
                                l), h.MutationObserver)) {
                            var k, n = !0,
                                x = function() {
                                    n = !1;
                                    l();
            ...
            return {
                ...
                handleResponse: function(a) {
                    ...
                    b.length && (a.success ? XF.setupHtmlInsert(a.html, function(a, c, d) {
                        b.replaceWith(a)
                    }) : (a = b.find(".js-unfurl-title a"),
                        a.text(b.data("url")).addClass("bbCodePlainUnfurl").removeClass("fauxBlockLink-blockLink"), b.replaceWith(a)))
                }
            }
        }(), XF.Event = function() {
                ...
                f = XF.create({
                    ...
                    _onEvent: function(a) {
                        ...
                        if (!b.isDefaultPrevented()) {
                            ...
                            else return console.error("You must provide a %1$s(e) method for your %1$s event handler",
                                this.eventType, this.eventNameSpace), a.preventDefault(), !1;
            ...
            return {
                watch: function(a) {
                    function e(a, b) {
                        ...
                        b = d(b);
                        return b.is("a") && !b.data("click-allow-modifier") && (a.ctrlKey || a.shiftKey || a.altKey ||
                            a.metaKey || 1 < a.which) || b.closest("[contenteditable=true]").length ? !1 : !0
                    }
            ...
            return {
                ...
                register: function(a, b) {
                    ...
                    return XF.Event.register("click",
                        a, b)
                },
                extend: function(a, b) {
                ...
                if (b) {
                    ...
                    for (e in b)
                        if (b.hasOwnProperty(e)) {
                            ...
                            } else if (n = g.text, m.text = XF.htmlspecialchars(g.text), "undefined" !== typeof g.desc && (m.desc = XF.htmlspecialchars(g.desc)), "undefined" !== typeof g.icon ? m.icon = d('<img class="autoCompleteList-icon" />').attr("src", XF.htmlspecialchars(g.icon)) : "undefined" !== typeof g.iconHtml && (m.icon = d('<span class="autoCompleteList-icon" />').html(g.iconHtml)),
                                m.icon && (m.icon = m.icon[0].outerHTML), g.extraParams) {
                                var x = g.extraParams,
                                    r;
                                for (r in x)
                        ...
                        this.headerHtml &&
                            (l = d("<li />").addClass("menu-header menu-header--small").attr("unselectable", "on").html(this.headerHtml), l.prependTo(this.$results));
            ...
            resultMouseEnter: function(a) {
                this.selectResult(d(a.currentTarget).index(),
                    !0)
            },
            ...
            insertSelectedResult: function(a) {
                ...
                0 <= this.selectedResult && (b = this.$results.children().get(this.selectedResult)) && (c = this.getResultText(b), this.options.beforeInsert && (c = this.options.beforeInsert(c,
                    b)), this.insertResult(c, b, a), c = !0);
                this.hideResults();
                return c
            },
            ...
            init: function() {
                ...
                this.ed ? (this.ed.events.on("keydown", XF.proxy(this, "keydown"), !0), this.ed.events.on("keyup", XF.proxy(this, "keyup"), !0), this.ed.events.on("click blur", XF.proxy(this, "blur")), d(this.ed.$wp).onPassive("scroll", XF.proxy(this, "blur"))) : (this.$input.on("keydown", XF.proxy(this, "keydown")), this.$input.on("keyup", XF.proxy(this, "keyup")), this.$input.on("click blur",
                    XF.proxy(this, "blur")), d(k).onPassive("scroll", XF.proxy(this, "blur")))
            },
            keydown: function(a) {
            ...
            show: function(a, b) {
                ...
                if (c)
                    if (this.visible = !0, this.ed) {
                        ...
                        for (var b = d("<div />"),
                                l = h.getComputedStyle(f[0]), m, p = "", v = 0; v < l.length; v++) m = l[v], p += m + ": " + l.getPropertyValue(m) + "; ";
                        b[0].style.cssText = p;
                        b.css({
                            position: "absolute",
                            height: "",
...
! function(c, g, e, h) {
    ...
    XF.ShareButtons = XF.Element.newHandler({
        ...
        click: function(a) {
            ...
            b.is(".shareButtons-button--share") || a.altKey || a.ctrlKey || a.metaKey || a.shiftKey || (a.preventDefault(), b.data("clipboard") ? (a = b.data("clipboard").replace("{url}", this.pageUrl).replace("{title}", this.pageTitle).replace("{desc}", this.pageDesc).replace("{image}", this.pageImage),
                navigator.clipboard.writeText(a).then(function() {
                    XF.flashMessage(XF.phrase("link_copied_to_clipboard"), 3E3)
                })) : d && d.match(/^https?:/i) && g.open(d, "share", "toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=" + f + ",height=" + e + ",left=" + (screen.width - f) / 2 + ",top=" + (screen.height - e) / 2))
        }
    });
        ...
        XF.Element.newHandler({
            ...
            recalculate: function(a, b) {
                ...
                e.is(":enabled") && (e.is(":checked") && !this.options.invert || this.options.invert && !e.is(":checked")) ? (d.prop("disabled", !1).removeClass("is-disabled"), f.prop("disabled", !1).removeClass("is-disabled").each(function(a, b) {
                    ...
                    XF.layoutChange();
                    k()
                }), XF.layoutChange()) : a || k()) : (this.options.hide && (a ? d.hide() : d.slideUp(h, XF.layoutChange), XF.layoutChange()), d.prop("disabled",
                    !0).addClass("is-disabled"), f.prop("disabled", !0).addClass("is-disabled").trigger("control:disabled").each(function(a, b) {
                    a = c(b);
                    b = a.data("disabled");
        ...
        create: function() {
            if (!this.created && (this.created = !0, 0 != this.options.remaining)) {
                ...
                if (this.options.incrementFormat) {
                    var d =
                        new RegExp(b + XF.regexQuote(a).replace("\\{counter\\}", "(\\d+)"));
        ...
        init: function() {
            if (XF.config.enableFormSubmitSticky) {
                ...
                b.length ? (this.$container = b, this.topOffset = this.options.topOffset, this.$fixEl = a.find(this.options.fixedChild), c(l).on("scroll", XF.proxy(this, "onScroll")).on("resize", XF.proxy(this, "recalcAndUpdate")), b = XF.getFixedOffsetParent(a), b.is("html") || (this.$fixedParent = b, b.on("scroll", XF.proxy(this, "onScroll"))), c(g.body).on("xf:layout", XF.proxy(this,
                    "recalcAndUpdate")), a.height() || setTimeout(XF.proxy(this, "recalcAndUpdate"), 250), this.recalcAndUpdate()) : console.error("Cannot float submit row, no container")
            }
        },
        recalc: function() {
            var a = this.$target;
...
! function(d, f, h) {
    ...
    XF.MenuClick = XF.Event.newHandler({
                    ...
                    if (!b.data("menu-loading")) {
                        ...
                        XF.ajax("get", b.data("href"), {}, function(a) {
                            ...
                            a.html && XF.setupHtmlInsert(a.html, function(a, c, e) {
                                ...
                                b.find(c).first().empty().html(a): b.html(a);
        ...
        getVerticalPosition: function(a, b, c) {
            this.menuIsUp = !1;
            b = !c && this.$target.hasFixedParent() ? this.getVerticalFixedPosition(a,
                b) : this.getVerticalAbsolutePosition(a, b);
    ...
    XF.ToggleClick = XF.Event.newHandler({
        ...
        hide: function(a) {
            if (this.isVisible() && !this.isTransitioning()) {
                ...
                this.$toggleParent && this.$toggleParent.removeClassTransitioned(b, XF.proxy(this,
                    "inactiveTransitionComplete"), a);
        ...
        show: function(a) {
            if (!this.isVisible() && !this.isTransitioning() && !this.getOtherToggles().filter(".is-transitioning").length)
                if (this.toggleUrl && !this.ajaxLoaded) this.load();
                    ...
                    this.closeOthers();
                    var b = this.options.activeClass;
                    this.$toggleParent && this.$toggleParent.addClassTransitioned(b,
                        this.activeTransitionComplete, a);
    ...
    XF.ToggleStorageDataInstance = XF.create({
        ...
        get: function(a, b, c) {
            ...
            if (!e && c[0] + c[1] < g) return delete this.dataCache[a][b],
    ...
    XF.Tabs = XF.Element.newHandler({
        ...
        init: function() {
            ...
            a = this.options.panes ? XF.findRelativeIf(this.options.panes,
                a) : a.next();
        ...
        activateTab: function(a) {
            ...
            b.length && c.length ? (this.$tabs.filter("." + d).removeClass(d).attr("aria-selected", "false").trigger("tab:hidden"), this.$panes.filter("." + d).removeClass(d).attr("aria-expanded", "false").trigger("tab:hidden"), b.addClass(d).attr("aria-selected", "true").trigger("tab:shown"),
                c.addClass(d).attr("aria-expanded", "true").trigger("tab:shown"), XF.layoutChange(), c.data("href") && !c.data("tab-loading") && (c.data("tab-loading", !0), XF.ajax("get", c.data("href"), {}, function(a) {
                    c.data("href", !1);
                    if (a.html) {
        ...
        tabClick: function(a) {
            var b = a.currentTarget,
                c = this.$tabs.index(b);
            if (-1 == c) console.error("Did not find clicked element (%o) in tabs",
                b);
            else {
                b = this.$tabs.eq(c);
    ...
    XF.QuickSearch = XF.Element.newHandler({
        ...
        init: function() {
            ...
            this.$select.on("change", XF.proxy(this,
                "updateSelectWidth"));
    ...
    XF.Element.register("h-scroller",
        "XF.HScroller");
